...
<body>
    <p>Halo {{ $name }},</p>
    <p>Kami menerima permintaan untuk mereset kata sandi akun Anda di website kami.</p>
    <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #6A1B9A; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #BDBDBD; border-radius: 8px; background-color: #FFFFFF;">
        ...
        <h2 style="text-align: center; color: #6A1B9A;">Reset Kata Sandi</h2>
        <p>Halo,</p>
        <p>Untuk mereset kata sandi Anda, gunakan kode berikut:</p>
        ...
        <p>Kode ini akan kedaluwarsa dalam <strong>5 menit</strong>. Jika Anda tidak meminta pengaturan ulang kata sandi, abaikan email ini.</p>
        <p>Salam hangat,<br>
